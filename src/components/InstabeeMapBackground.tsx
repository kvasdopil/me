  ...
  useEffect(() => {
          ...
          map.addLayer({
            ...
            paint: {
              "fill-color": [
                ...
                ["get", "color"],
                "green",
                "#22c55e", // Green for regions containing cities
                "yellow",
                "#eab308", // Yellow for regions within 5km
                "blue",
                "#3b82f6", // Blue for regions within 10km
                "gray",
                "#9ca3af", // Gray for regions farther than 10km
                "#9ca3af", // Default gray
              ],
              "fill-opacity": 0.5,
            },
    ...
    if (citiesGeoJson) {
      map.on("load", () => {
        ...
        const cityFeatures = citiesGeoJson.features.filter((f) => f.geometry.type === "Point");
